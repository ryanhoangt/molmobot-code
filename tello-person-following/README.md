...
```bash
mkdir -p **resources**
curl -L -o resources/mobilenet_ssd_deploy.prototxt https://raw.githubusercontent.com/chuanqi305/MobileNet-SSD/blob/master/deploy.prototxt
curl -L -o resources/mobilenet_ssd.caffemodel https://raw.githubusercontent.com/chuanqi305/MobileNet-SSD/blob/master/mobilenet_iter_73000.caffemodel
```
